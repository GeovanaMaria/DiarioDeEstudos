...
public class ExpressoesAritmeticas {
    ...
    Assim como na matemática existe uma ordem de precedêndia, que deve ser seguida assim o calculo feito no
    programa será executado da maneira correta.
...
-------------------------------------------------------------------------------------------------------------------
Exercicio 1: Leia a largura e altura de um terreno retangular e o valor do metro quadrado. Retorne a área e o
             preço do terreno com duas casas decimais.

//nesse programa deve se aplicar o (printf) para ter a precisão de duas casas decimais, como solicitado no
  exercício.
...
----------------------------------------------------------------------
 ...
 Exercicío 3: Ler o nome e idade de duas pessoas e mostrar uma mensagem com os nomes, e a idade média entre essas
